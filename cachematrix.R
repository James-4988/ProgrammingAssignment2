...
## functions do
## The aim in this experiment is to write 2 functions: "makeCacheMatrix" and "cacheSolve" that cache the inverse of a matrix
...
## Write a short comment describing this function
## cacheSolve is a function which computes the inverse of the special "matrix" returned by makeCacheMatrix above. If the
...
##Exmaples Using the 2 new functions
